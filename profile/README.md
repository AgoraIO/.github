...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/agora-divider-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="./assets/agora-divider-light.svg">
  <img src="./assets/agora-divider-light.svg" width="100%" alt="">
</picture>
...
| Repository | Best for |
| --- | --- |
| [API-Examples-Web](https://github.com/AgoraIO/API-Examples-Web) | Learning Agora voice and video on the web |
| [API-Examples](https://github.com/AgoraIO/API-Examples) | Exploring cross-platform native SDK capabilities |
